...
//        lbl_distName.setBounds(620,25,150,30);
//        lbl_distName.setFont(new Font("Georgia", Font.BOLD, 18));
//        add(lbl_distName);
//        bg_sort.add(lbl_distName);
//
//        cmb_state.setBounds(370,30,180,25);
//        add(cmb_state);
//        cmb_state.setFont(new Font("Georgia", Font.BOLD, 14));
//        bg_sort.add(cmb_state);
//
//        cmb_dist.setBounds(800,30,160,25);
//        add(cmb_dist);
//        cmb_dist.setFont(new Font("Georgia", Font.BOLD, 14));
//        bg_sort.add(cmb_dist);
