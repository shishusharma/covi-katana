...
public class JcIndia extends JPanel{
...
//
//        dataset.setValue( "Today Recoverd" ,Double.valueOf(getA1()) );
//        dataset.setValue( "Total Active" , Double.valueOf( getB1()) );
//        dataset.setValue( "Total Death" , Double.valueOf(getC1()) );
//        dataset.setValue( "Total Infected" , Double.valueOf(getD1()));
    ...
    private static JFreeChart createChart( PieDataset dataset ) {
        JFreeChart chart = ChartFactory.createPieChart(
                "Covid-19 Stats of India",   // chart title
                dataset,          // data
                true,             // include legend
                true,
                false);
