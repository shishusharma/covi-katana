...
/*
	class Registration : to allow the user to register on the application.
						 uses mailAPI for sending OTP and validating the user.
 */
...
public class Registration extends JPanel {
	...
	public Registration() {
		...
		//setting up the layout and dimensions
		setVisible(false);
		 setLayout(null);
		...
		btnLogin.addActionListener(new ActionListener() {
			...
			//Using smtp for sending emails to the user
		...
		//Necessary labels,textfields and buttons and their styling
...
//		btnValidateOtp's action listener
		btnValidateOtp.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				if(Integer.parseInt(txtOtp.getText())==OTP){
					...
					lblOtpSend.setBounds(270, 340+y, 195, 20);
					lblOtpSend.setForeground(Color.red);
	...
	//Once the otp is validated, the user data is stored inside the database using this function
	public void insertValueTofLogin(String name,String phone,String aadhaar,String email) throws ClassNotFoundException {
		...
		try {
			...
			//we comment this because at in database we already added trigger called after_insertion_flogin
	...
	//after registration is complete this clears all field
