...
/*
	class StateWiseUpdate : This class displays the data of Covid-19, including
							infected, deaths,recovered,etc.
							Also piechart is displayed for individual states using JFreeChart.
 */
...
public class StateWiseUpdate extends JPanel
{
	...
	public StateWiseUpdate()
	{
		...
		//Adding a JTable to display the data of all the states
		jt1=new JTable(tm);
		...
		//Adding other labels and buttons to display data and their styling
...
//
	...
	//Parsing the incoming data from the API using simpleJSON
