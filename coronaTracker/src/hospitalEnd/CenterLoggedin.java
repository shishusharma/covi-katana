...
/*
    class for vaccinator dashboard : providing the center details and
        a table which displays the due vaccinations.
 */
...
//        }while(len<3);
    ...
    //data to be displayed from the database.
    public void showTable() {
        ...
        try {
            //query to get the data to be displayed
